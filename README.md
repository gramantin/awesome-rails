...
- [activerecord-postgres_enum](https://github.com/bibendi/activerecord-postgres_enum) - A gem to adds migration and schema.rb support to PostgreSQL enum data types. - [rubygems](https://rubygems.org/gems/activerecord-postgres_enum)
...
- [frozen_record](https://github.com/byroot/frozen_record) - A gem to provide ActiveRecord-like interface to query static YAML files. - [rubygems](https://rubygems.org/gems/frozen_record)
